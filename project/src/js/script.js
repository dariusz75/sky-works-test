function init() {
 ...
 function handleTick(event) {
     ...
     // frame 2 animation
     createjs.Tween.get(frame2gradientText).wait(5000).to({alpha: 1},1000).wait(3000).to({alpha: 0},1000);
     createjs.Tween.get(frame2greyText).wait(6000).to({alpha: 1},1000).wait(2000).to({alpha: 0},1000);
     createjs.Tween.get(frame2stamp).wait(6000).to({x:0}, 1000, createjs.Ease.quadOut).wait(2000).to({alpha: 0},1000);
